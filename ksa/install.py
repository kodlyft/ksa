...
from ksa.ksa.wizard.operations.setup_ksa_vat_setting import create_ksa_vat_setting
...
def add_print_formats():
	frappe.reload_doc("ksa", "print_format", "detailed_tax_invoice", force=True)
	frappe.reload_doc("ksa", "print_format", "simplified_tax_invoice", force=True)
	frappe.reload_doc("ksa", "print_format", "tax_invoice", force=True)
